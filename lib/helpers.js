...
// Hoang Nguyen add this to support send a suggest search
exports.doSuggestAndNormalizeResults = function (searchUri, searchOpts, cb) {

  // merge `searchOpts` with default user-level search options
  searchOpts.sort = searchOpts.sort || [ { _score: 'desc' } ];
