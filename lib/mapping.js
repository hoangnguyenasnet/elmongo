...
.forEach(function (path) {
	...
	pathArray.forEach(function (pathEntry, i) {
		...
		if (i === pathArray.length - 1) {
			...
			// Hoang Nguyen add this to allow completion type
			if (
				(pathInfo.options && pathInfo.options.completion) ||
				(pathInfo.caster && pathInfo.caster.options && pathInfo.caster.options.completion)
			) {
